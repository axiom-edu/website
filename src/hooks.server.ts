...
const isSupabaseConfigured =
  PUBLIC_SUPABASE_URL &&
  PUBLIC_SUPABASE_URL !== "" &&
  !PUBLIC_SUPABASE_URL.includes("REPLACE_ME") &&
  PUBLIC_SUPABASE_ANON_KEY &&
  PUBLIC_SUPABASE_ANON_KEY !== "" &&
  !PUBLIC_SUPABASE_ANON_KEY.includes("REPLACE_ME")

export const supabase: Handle = async ({ event, resolve }) => {
  // If Supabase is not configured, provide mock implementations for frontend development
